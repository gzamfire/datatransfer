...
SET !ENCRYPTION NO
TAG POS=1 TYPE=INPUT:PASSWORD FORM=NAME:loginform ATTR=NAME:password CONTENT=Standrews8
...
imacro += "TAG POS=1 TYPE=A ATTR=TXT:Daily<SP>Samples<SP>-<SP>" + str(68) + "\n"
...
placeContents(sys.argv[1] + ".iim", imacro)
